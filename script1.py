...
load_dotenv()
"""________________________________________________MISP________________________________________________"""
...
"________________________________________________CONVERT TO CSV________________________________________________"
...
"________________________________________________CONVERT TO JSON_______________________________________________"
...
"___________________________________________________FIN MODEL________________________________________________________"
...
def remove_last_dot(domaine):
            last_dot_position=domaine.rfind('.')
            if last_dot_position==-1:
                return domaine
            return domaine[:last_dot_position] + domaine[last_dot_position +1:]
...
def handle_packet(packet):
    ...
    if DNS in packet and IP in packet:
        ...
        tldd=(extracted.domain + '.'+ extracted.suffix)
        ...
        print(modele)
        if validate_fqdn(query) == True or check_NXDOMAIN (domain_name) == True or check_domain(tldd) == True or modele==True:
            attack=True      
        ...
        rows.append ({
            ...
            'modele': 'true'if modele ==   True else 'false',
...
def launch_script2(dst, src, query, protocol, src_port, dst_port):
    ...
    subprocess.call(["python", "/home/mariem/pfe/script2.py"] + args)
...
def script_launch (attack,args):
        ...
        subprocess.call(["python", "/home/iheb_bachouel/pfe/script2.py"] + args, shell=True)
